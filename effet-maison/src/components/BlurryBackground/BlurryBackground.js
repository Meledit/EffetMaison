...
function BlurryBackground() {
  return (
    <BlurryBackgroundContainer>
        ...
        <BlurryBackgroundCircle color={"#ecca87"} X={5} Y={5} size={40}></BlurryBackgroundCircle>
        <BlurryBackgroundCircle color={"#ecca87"} X={100} Y={50} size={45}></BlurryBackgroundCircle>
        <BlurryBackgroundCircle color={"#9FFFBB"} X={46} Y={110} size={25}></BlurryBackgroundCircle>    
        <BlurryBackgroundCircle color={"#ecca87"} X={54} Y={100} size={23}></BlurryBackgroundCircle>
    </BlurryBackgroundContainer>
  )
}
